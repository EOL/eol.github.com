...
NOTE: we might want to think about customizing an RDoc template to be styled like http://www.eol.org.  A great example of styling RDoc to match a website: http://code.macournoyer.com/thin/doc/files/README.html
